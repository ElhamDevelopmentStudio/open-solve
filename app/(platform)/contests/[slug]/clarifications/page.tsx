import { ContestClarifications } from "@/components/contests/contest-clarifications";
...
export default async function ContestClarificationsPage({ params }: { params: Params | Promise<Params> }) {
  ...
  return (
    <HydrationBoundary state={state}>
      <ContestClarifications slug={slug} />
    </HydrationBoundary>
  );
}

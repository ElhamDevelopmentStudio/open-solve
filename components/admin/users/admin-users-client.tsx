       ...
       <Card className="border-border/60 bg-card/80">
         <CardHeader className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
           ...
           <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
             ...
             <Select value={roleFilter ?? "all"} onValueChange={(value) => setRoleFilter(value === "all" ? undefined : (value as UserRole))}>
             ...
             <Select value={statusFilter ?? "all"} onValueChange={(value) => setStatusFilter(value === "all" ? undefined : (value as UserStatus))}>
               <SelectTrigger className="w-full sm:w-40">
               ...
               <Card className="border-border/60 bg-card/80">
                 ...
                 <CardContent className="space-y-3 text-sm">
                   <div className="flex items-center justify-between">
                     <span>Role</span>
                     <Select defaultValue={user.role} onValueChange={(value) => onRoleChange(value as UserRole)}>

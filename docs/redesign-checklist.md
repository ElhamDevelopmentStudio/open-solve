...
- [ ] `/auth/forgot-password` (app/(auth)/auth/forgot-password/page.tsx)
- [ ] `/auth/reset-password` (app/(auth)/auth/reset-password/page.tsx)
- [ ] `/auth/verify-email` (app/(auth)/auth/verify-email/page.tsx)
- [ ] `/auth/magic-link` (app/(auth)/auth/magic-link/page.tsx)

## [03] Reader Experience (public browsing)

- [ ] `/discuss` (app/(reader)/discuss/page.tsx)
- [ ] `/discuss/[threadId]` (app/(reader)/discuss/[threadId]/page.tsx)
- [ ] `/leaderboards` (app/(reader)/leaderboards/page.tsx)
- [ ] `/leaderboards/tag/[slug]` (app/(reader)/leaderboards/tag/[slug]/page.tsx)
- [ ] `/leaderboards/difficulty/[level]` (app/(reader)/leaderboards/difficulty/[level]/page.tsx)
- [ ] `/leaderboards/[window]` (app/(reader)/leaderboards/[window]/page.tsx)
- [ ] `/tags/[slug]` (app/(reader)/tags/[slug]/page.tsx)
- [ ] `/problems` (app/(reader)/problems/page.tsx)
- [ ] `/problems/[slug]` (app/(reader)/problems/[slug]/page.tsx)
- [ ] `/problems/[slug]/discuss` (app/(reader)/problems/[slug]/discuss/page.tsx)
- [ ] `/problems/[slug]/discuss/[threadId]` (app/(reader)/problems/[slug]/discuss/[threadId]/page.tsx)
- [ ] `/problems/[slug]/editorial` (app/(reader)/problems/[slug]/editorial/page.tsx)
- [ ] `/problems/[slug]/trails` (app/(reader)/problems/[slug]/trails/page.tsx)
